...
public:
   ...
   */
  static std::array<HexPath, 2> getAllEdgeRepresentations(HexDirection d);

  /**
   * @brief Get a vector of all representations of the edge
   *
   * @return std::vector<Element>
   */
  const std::vector<Edge> getAllRepresentations() const;

  /**
   * @brief Get the other representation of the edge
   *
   * @return std::vector<Element>
   */
  const std::vector<Edge> getOtherRepresentations() const;

  /**
   * @brief Get representations of all adjacent edges. The two "local" edges
   * first and then both representations of the first "distant" edge, and then
   * the second edge
   *
   * @param d
   * @return std::array<HexPath, 6>
   */
  static std::array<HexPath, 6> getAdjacentEdges(HexDirection d);
   ...
   */
  static std::array<HexPath, 4> getDistantAdjacentEdges(HexDirection d);
};