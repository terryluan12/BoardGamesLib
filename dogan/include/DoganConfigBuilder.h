...
public:
  ...
  DoganConfigBuilder &
  setTileLocations(std::vector<PublicCoordinate2D> tileLocations);
  ...
  DoganConfigBuilder &
  setDevelopmentConfig(PublicConfiguration developmentConfig);
  DoganConfigBuilder &setNumberConfig(PublicConfiguration numberConfig);
  DoganConfigBuilder &
  setPortResourceConfig(PublicConfiguration portResourceConfig);
  ...
  DoganConfigBuilder &setPortLocations(
