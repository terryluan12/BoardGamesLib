...
//! Public interfaces in the %Dogan library
  ...
  public:
     ...
     */
    void buildStructure(int playerID, int structType,
     ...
     */
    void useRobber(int playerID, Coordinate2D tileLocation, int direction);
     ...
     */
    void useMonopolyDevelopmentCard(int playerID, int resource);
    /**
     ...
     * @return false
     */
    bool hasStructure(Coordinate2D coord, int direction,
