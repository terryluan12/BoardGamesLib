...
namespace Dogan {
/**
 * @brief Thrown when a player, or the bank does not have enough resources to
 * perform an action
 *
 */
...
/**
 * @brief Thrown when a player, or the bank does not have enough development
 * cards to perform an action
 *
 */
...
/**
 * @brief Thrown when a player does not have enough available structures to
 * build a structure
 *
 */
...
/**
 * @brief Thrown when the player attempts to access a building on a vertex that
 * does not exist
 *
 */
...
/**
 * @brief Thrown when the player attempts to access a coordinate that does not
 * exist
 *
 */
...
/**
 * @brief Thrown when the player attempts to build a structure on a location
 * that is invalid
 *
 */
...
/**
 * @brief Thrown when the game tries to perform an action with a player that
 * does not exist
 *
 */
