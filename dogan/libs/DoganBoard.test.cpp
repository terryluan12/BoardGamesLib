...
TEST(BoardTest, UpgradeVillageFailTest) {
  ...
  std::shared_ptr<DoganStructure> dv = std::make_shared<DoganBuilding>(DoganBuilding(0, StructureType::CITY, {{0, 0}, Direction::NORTH}));
  EXPECT_THROW({
...
TEST(BoardTest, UpgradeVillageSuccessTest) {
  DoganConfig config = DoganConfig();
  DoganBoard board{config};
  std::shared_ptr<DoganStructure> dv1 = std::make_shared<DoganBuilding>(DoganBuilding(0, StructureType::VILLAGE, {{0, 0}, Direction::NORTH}));
  std::shared_ptr<DoganStructure> dv2 = std::make_shared<DoganBuilding>(DoganBuilding(0, StructureType::CITY, {{0, 0}, Direction::NORTH}));
  EXPECT_NO_THROW({
