...
// Resource Functions
void DoganBank::addResource(const ResourceType r, const size_t n) {
...
void DoganBank::removeResource(const ResourceType r, const size_t n) {
  if (resources[static_cast<size_t>(r)] < n) {
